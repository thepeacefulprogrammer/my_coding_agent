"""Tests for FileTreeModel and FileTreeWidget functionality."""
...
import pytest
from code_viewer.core.file_tree import FileTreeModel, FileTreeWidget
...
class TestFileTreePerformanceOptimizations:
    ...
    def optimized_model(self, tmp_path):
        ...
        from code_viewer.core.file_tree import FileTreeModel
