    ...
    def update_file_content(self, content, filename=None):
        ...
        try:
            ...
            if lexer:
                ...
                # Using the actual tag names generated by Chlorophyll/Pygments
                color_mapping = {
                    # Keywords (blue)
                    ...
                    "Token.Keyword.Other": "#81A1C1",
                    
                    # Strings (green)
                    "Token.Literal.String": "#A3BE8C",
                    "Token.Literal.String.Double": "#A3BE8C",
                    "Token.Literal.String.Single": "#A3BE8C",
                    "Token.Literal.String.Doc": "#A3BE8C",
                    "Token.Literal.String.Backtick": "#A3BE8C",
                    "Token.Literal.String.Other": "#A3BE8C",
                    "Token.Literal.String.Interpol": "#A3BE8C",
                    
                    # Comments (gray)
                    "Token.Comment": "#616E88",
                    "Token.Comment.Single": "#616E88",
                    "Token.Comment.Multiline": "#616E88",
                    "Token.Comment.Special": "#616E88",
                    
                    # Numbers (purple)
                    "Token.Literal.Number": "#B48EAD",
                    "Token.Literal.Number.Integer": "#B48EAD",
                    "Token.Literal.Number.Float": "#B48EAD",
                    "Token.Literal.Number.Hex": "#B48EAD",
                    "Token.Literal.Number.Bin": "#B48EAD",
                    "Token.Literal.Number.Oct": "#B48EAD",
