...
class DebugWindow(QMainWindow):
    ...
    def add_test_messages(self):
        ...
        self.chat_widget.add_user_message("Short message")
        self.chat_widget.add_assistant_message(
            ...
            "to fill the entire available space in the container widget."
        )
    ...
    def print_widget_info(self):
        ...
        if hasattr(self.chat_widget, "send_button"):
            ...
            print(
                f"Send button fixed size: {self.chat_widget.send_button.maximumSize()}"
            )  # type: ignore
        else:
        ...
        for msg_id, bubble in bubbles.items():
            ...
            print(
                f"  Size policy: H={size_policy.horizontalPolicy()}, V={size_policy.verticalPolicy()}"
            )
            ...
            if content_widget:
                ...
                print(
                    f"  Content label size policy: H={content_policy.horizontalPolicy()}, V={content_policy.verticalPolicy()}"
                )
    ...
    def test_bubble_height_fix(self):
        ...
        for msg_id, bubble in bubbles.items():
            ...
            if content_widget:
                ...
                print(
                    f"Message {msg_id[:8]}... - Content height needed: {content_height}, Actual height: {actual_height}"
                )
